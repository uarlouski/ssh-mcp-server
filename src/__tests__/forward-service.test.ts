...
import { handleForwardService } from '../handlers/forward-service.js';
...
describe('handleForwardService', () => {
    ...
    it('should start a named service with explicit local port', async () => {
        ...
        const result = await handleForwardService(
    ...
    it('should throw error when service not found', async () => {
        ...
        await expect(
            handleForwardService({ serviceName: 'nonexistent' }, context)
    ...
    it('should throw error when server not found', async () => {
        ...
        await expect(
            handleForwardService({ serviceName: 'test-service' }, context)
    ...
    it('should propagate port forward setup errors', async () => {
        ...
        await expect(
            handleForwardService({ serviceName: 'production-database' }, context)
